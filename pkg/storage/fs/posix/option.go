...
type Options struct {
	// posix fs works on top of a dir of uuid nodes
	...
	// propagate mtime changes as tmtime (tree modification time) to the parent directory when user.posix.propagation=1 is set on a node
